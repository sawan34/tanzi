...
Refresh</a>
    ...
    <div align="left" >
                            ...
                            <table width="100%" style="border: 1px solid #000; width: 100%; margin-bottom: 50px" cellspacing="0" cellpadding="2" >
								<thead>
									<tr style="text-align:center;background-color: #ECF7F6;">
									...
									<!--	<th scope="col" style=" border: 1px solid #000; padding: 6px;"><?php _e('SKU', 'woothemes'); ?></th>	-->
									   ...
									   <th scope="col" style=" border: 1px solid #000; padding: 6px;"><?php _e('List Price', 'woothemes'); ?></th>
...
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;text-transform:uppercase"><?php echo $product->get_title(); ?></td>
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;"><?php echo $product->sku; ?></td>											
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;white-space:nowrap;"><?php echo $product->price; ?></td>
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;color:#F00;white-space:nowrap;"><?php echo $product->sale_price; ?></td>	
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;"><?php echo $product->get_attribute( 'pa_certno' ); ?></td>
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;"><?php echo $product->get_attribute( 'pa_lotid' ); ?></td>
...
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;white-space:nowrap;"><?php echo $product->get_attribute( 'pa_zsize' ); ?></td>
...
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;white-space:nowrap;"><?php echo $product->get_attribute( 'pa_measurment' ); ?></td>
...
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;white-space:nowrap;"><?php echo $product->get_attribute( 'pa_memo' ); ?></td>
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;white-space:nowrap;"><?php echo $product->get_attribute( 'pa_zcost' ); ?></td>
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;white-space:nowrap;"><?php echo $product->get_attribute( 'pa_xsale' ); ?></td>
<td class="order-number" style="padding: 0 5px;border: 1px solid #000;white-space:nowrap;"><?php echo $product->get_attribute( 'pa_zsale' ); ?></td>
